...
Lo que se ha hecho ha sido ejecutar el código que calculaba el mínimo y el máximo de la columna 5 simultáneamente sobre un conjunto que, como vimos en clase, es más pequeño que el empleado originalmente. A continuación se muestra la información del proceso que nos ofrece el servidor donde podemos observar que 
